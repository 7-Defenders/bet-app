...
class _LeagueSummaryState extends State<LeagueSummary> {
  ...
  Widget adminPanel() {
    ...
    return SizedBox(
      ...
      child: Column(
        children: [
          nunitoText("League admin panel", 22, FontWeight.bold, Colors.black),
          nunitoText("You can change league settings here.", 14,
              FontWeight.normal, Colors.black),
          const Spacer(),
          // update league name, league visibility (private/public), entry fee, competitions included options
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceEvenly,
            children: [
              SizedBox(
                ...
                child: Align(
                  ...
                  child:
                      nunitoText('Name', 16, FontWeight.normal, Colors.black),
                ),
              ),
              SizedBox(
                width: width * 0.4,
                child: Align(
                  ...
                  child: TextField(
                    onChanged: (value) {
                      fieldsToUpdate['leagueName'] = value;
                    },
            ...
            children: [
              SizedBox(
                ...
                child: Align(
                  alignment: Alignment.centerLeft,
                  child: nunitoText(
                      'Visibility', 16, FontWeight.normal, Colors.black),
                ),
              ),
              SizedBox(
                width: width * 0.4,
                child: Align(
                  ...
                  child: DropdownButton<String>(
                    ...
                    onChanged: (value) {
                      fieldsToUpdate['private'] = value == 'Private';
                    },
                  ),
                ),
              ),
          ...
          Row(
            ...
            children: [
              ElevatedButton(
                ...
                child:
                    nunitoText('Cancel', 14, FontWeight.normal, Colors.white),
              ),
              ElevatedButton(
                onPressed: () async {
                  final scaffoldMessenger = ScaffoldMessenger.of(context);
                  ...
                  await updateLeagueSettings(fieldsToUpdate);

                  final snackBar = SnackBar(
                    backgroundColor: const Color.fromARGB(255, 96, 179, 255),
                    content: nunitoText('Successfully updated league settings',
                ...
                child: nunitoText('Save', 14, FontWeight.bold, Colors.white),
              ),
            ],
          ),
        ],
            ...
            child: ListView.builder(
              ...
              itemBuilder: (BuildContext context, int index) {
                return ExpansionTile(
                  title: nunitoText('Competitions included', 16,
                      FontWeight.normal, Colors.black),
                  children: competitionRefs!.map((league) {
                    return ListTile(
                      title: nunitoText(competitionRefs![index], 16,
  ...
  Future<void> leaveLeague() async {
    ...
    await http.delete(Uri.parse(
        'https://bet-app-e520a.ew.r.appspot.com/v1/users/$uid/leagues/${widget.leagueID}'));
  }

  Future<void> updateLeagueSettings(Map<String, dynamic> fieldsToUpdate) async {
    final uid = FirebaseAuth.instance.currentUser!.uid;
    await http.put(
      Uri.parse(
        'https://bet-app-e520a.ew.r.appspot.com/v1/leagues/${widget.leagueID}/users/$uid/edit',
      ),
      body: fieldsToUpdate,
    );
  }
  ...
  Future<void> fetchLeagueData() async {
    ...
    final uri =
        'https://bet-app-e520a.ew.r.appspot.com/v1/leagues/${widget.leagueID}/users';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: nunitoText(leagueName == null ? 'League Name' : leagueName!, 24,
            FontWeight.bold, Colors.black),
        centerTitle: true,
      ),
      body: Column(
        children: [
          ...
          GestureDetector(
            ...
            child: Center(
              child: Row(
                ...
                children: [
                  nunitoText(leagueCode == null ? 'League Name' : leagueCode!,
          ...
          Row(
            children: [
              ...
              //     ),
              //     child: nunitoText(
              //         'Admin panel', 14, FontWeight.bold, Colors.white),
              //   )
              // else
              //   const SizedBox(),
              ElevatedButton(
              ...
              ElevatedButton(
                ...
                child: nunitoText(
                    'Leave the league', 14, FontWeight.bold, Colors.white),
              ),
            ],
          ),
          SizedBox(
